...
memoria_total=$(free | grep -i mem | awk -F" " '{ print $2 }')
memoria_consumida=$(free | grep -i mem | awk -F" " '{ print $3 }')
...
then
mail -s "Consumo de memoria acima do limite" coteste2024@gmail.com<<del
